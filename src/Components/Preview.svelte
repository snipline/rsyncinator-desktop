<script lang="ts">
  ...
  } transition ease-in w-full bg-indigo-600 text-white rounded p-4 shadow-md disabled:text-gray-500 disabled:bg-gray-400 hover:bg-indigo-500 active:bg-indigo-700 focus:bg-indigo-700`;
